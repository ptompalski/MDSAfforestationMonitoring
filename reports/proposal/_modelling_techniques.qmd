...
|-----------------------|---------------------------------------------------------------|--------------------------------------------------------|
| **Logistic Regression** | Establishes an interpretable baseline linking features to survival probability | Fast to fit; coefficients guide feature selection      |
| **Random Forest**       | Models complex interactions without extensive preprocessing   | Robust to noisy, mixed‑type predictors                |
| **AdaBoost**            | Emphasizes hard‑to‑classify trees to boost overall accuracy   | Iteratively focuses on difficult cases                 |
| **Ordinal Logistic**    | Discretizes time‑since‑planting into ordered survival bins    | Leverages ordinal relationships in survival timing    |
| **LSTM Network**        | Exploits full time‑series spectral sequences for trend detection | Learns long‑term dependencies across dates            |
